...
export function InlineContactSection({ locale: _locale, preferredOption }: InlineContactSectionProps) {
  return (
    <section className="bg-[var(--color-night)] px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
          <div>
            <p className="eyebrow text-[var(--color-gold-sun)]">Get in Touch</p>
            <h2 className="text-h2 mt-4 text-white">
              Ready to discover your Sea&apos;cret?
            </h2>
            <p className="mt-4 max-w-md text-white/60">
              Schedule a private viewing or request detailed information about our residences.
