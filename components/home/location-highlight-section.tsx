...
export function LocationHighlightSection({ locale }: LocationHighlightSectionProps) {
      ...
      <div className="section-shell">
        <ScrollReveal>
          <SectionHeading
            ...
            title="Greece's best-kept secret"
            description="Nestled on the northern shore of the Gulf of Corinth, Chiliadou offers untouched beauty just hours from Athens."
            align="center"
          />
        </ScrollReveal>
            ...
            <ScrollReveal key={item.title} delay={i * 0.1}>
              <div className="text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-deep-teal)]/10">
                  <item.icon className="h-6 w-6 text-[var(--color-deep-teal)]" />
                </div>
