    ...
    <div className="tile flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-5">
        ...
        {whatsappUrl && (
          ...
          >
            <div className="w-10 h-10 rounded-full bg-[#25D366]/10 flex items-center justify-center flex-shrink-0 transition-colors group-hover:bg-[#25D366]/20">
        ...
        {whatsappUrl && emailUrl && <div className="h-px bg-[var(--color-deep-teal)]/8" />}
